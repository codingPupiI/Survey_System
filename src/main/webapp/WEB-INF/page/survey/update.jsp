...
<div class="layuimini-container">
    <div class="layuimini-main">
        <form class="layui-form" action="" lay-filter="myform">
            <input type="hidden" name="id" lay-verify="required" value="${survey.id}" autocomplete="off"  class="layui-input">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="checkbox" name="anon" lay-skin="switch"  lay-text="ON|OFF" value="0">
                </div>
            </div>
