 ...
 * Generated at: 2021-06-04 12:05:50 UTC
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("                        <div class=\"layui-inline\">\r\n");
      out.write("                            <button type=\"submit\" class=\"layui-btn layui-btn-primary\"  lay-submit lay-filter=\"data-search-btn\"><i class=\"layui-icon\"></i> 搜 索</button>\r\n");
      out.write("                        </div>\r\n");
      out.write("                    </div>\r\n");
      out.write("                </form>\r\n");
      out.write("            </div>\r\n");
      ...
      out.write("                <button class=\"layui-btn layui-btn-sm layui-btn-sm data-add-btn\" lay-event=\"edit\"> 修改 </button>\r\n");
      out.write("                <button class=\"layui-btn layui-btn-sm layui-btn-danger data-delete-btn\" lay-event=\"delete\"> 删除 </button>\r\n");
      out.write("                <button class=\"layui-btn layui-btn-sm layui-btn-sm data-delete-btn\" lay-event=\"editque\"> 设计问卷 </button>\r\n");
      out.write("                <button class=\"layui-btn layui-btn-sm layui-btn-sm data-delete-btn\" lay-event=\"preview\"> 预览问卷 </button>\r\n");
      out.write("                <button class=\"layui-btn layui-btn-sm layui-btn-sm data-delete-btn\" lay-event=\"publish\"> 发布问卷 </button>\r\n");
      out.write("                <button class=\"layui-btn layui-btn-sm layui-btn-sm data-delete-btn\" lay-event=\"query_detail\"> 问卷详情 </button>\r\n");
      out.write("            </div>\r\n");
      out.write("        </script>\r\n");
      out.write("\r\n");
      ...
      out.write("                {field: 'title', title: '问卷标题'},\r\n");
      out.write("                {field: 'url',width:500, title: '问卷URL'},\r\n");
      out.write("                {field: 'startTime', width: 200, title: '开始时间'},\r\n");
      out.write("                {field: 'endTime', width: 200, title: '结束时间'},\r\n");
      out.write("                {field: 'state', width: 130, title: '状态'},\r\n");
      out.write("                {field: 'name', width: 100, title: '创建人',templet:'<div>{{d.admin.name}}</div>'},\r\n");
      out.write("                {field: 'createTime',width: 200,title: '创建时间'}\r\n");
      out.write("            ]],\r\n");
      ...
      out.write("                contentType: 'application/json'\r\n");
      out.write("                , where: {\r\n");
      out.write("                    \"title\": data.field.title || null,\r\n");
      out.write("                    \"state\": data.field.state || null,\r\n");
      out.write("                }\r\n");
      out.write("            }, 'data');\r\n");
      out.write("\r\n");
      ...
      out.write("                    }\r\n");
      out.write("                });\r\n");
      out.write("            } else if (obj.event === 'edit') {  // 监听添加操作\r\n");
      out.write("                var checkStatus = table.checkStatus('currentTableId')\r\n");
      out.write("                    , data = checkStatus.data;\r\n");
      out.write("                var arr=[];\r\n");
      out.write("                for (index in data){\r\n");
      ...
      out.write("                    //layer.full(index);\r\n");
      out.write("                });\r\n");
      out.write("            } else if (obj.event === 'editque') {  // 监听添加操作\r\n");
      out.write("                var checkStatus = table.checkStatus('currentTableId')\r\n");
      out.write("                    , data = checkStatus.data;\r\n");
      out.write("                var arr=[];\r\n");
      out.write("                for (index in data){\r\n");
      ...
      out.write("                    //layer.full(index);\r\n");
      out.write("                });\r\n");
      out.write("            } else if (obj.event === 'preview') {  // 监听添加操作\r\n");
      out.write("                console.log(\"搁这1\");\r\n");
      out.write("                var checkStatus = table.checkStatus('currentTableId')\r\n");
      out.write("                    , data = checkStatus.data;\r\n");
      out.write("                var arr=[];\r\n");
      out.write("                for (index in data){\r\n");
      ...
      out.write("            } else if (obj.event === 'publish') {  // 监听添加操作\r\n");
      out.write("                console.log(\"搁这1\");\r\n");
      out.write("                var checkStatus = table.checkStatus('currentTableId')\r\n");
      out.write("                    , data = checkStatus.data;\r\n");
      out.write("                var arr=[];\r\n");
      ...
      out.write("\r\n");
      out.write("                var index = layer.open({\r\n");
      out.write("                    title: '编辑问卷',\r\n");
      out.write("                    type: 2,\r\n");
      out.write("                    shade: 0.2,\r\n");
      out.write("                    maxmin:true,\r\n");
      out.write("                    shadeClose: true,\r\n");
      out.write("                    area: ['100%', '100%'],\r\n");
      out.write("                    content: '../static/page/table/edit.html',\r\n");
      out.write("                });\r\n");
      out.write("                $(window).on(\"resize\", function () {\r\n");
      out.write("                    layer.full(index);\r\n");
      out.write("                });\r\n");
